...
print(config['appFilePath'], config['projectArn'], config['poolArn'], config['awsAccessKeyId'], config['awsSecretKey'])
...
our_upload_arn = upload_df_file(config['appFilePath'], "IOS_APP")
